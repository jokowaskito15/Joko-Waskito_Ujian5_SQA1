package com.juaracoding.selenium.automationpractice.main;

import org.openqa.selenium.JavascriptExecutor;
import org.openqa.selenium.WebDriver;

import com.juaracoding.selenium.automationpractice.driver.DriverSingleton;
import com.juaracoding.selenium.automationpractice.pages.addtocart.AddToCart;
import com.juaracoding.selenium.automationpractice.pages.createaccount.Login;
...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		login.SignIn();
		login.CreateAccount("jokogantenggggg7@gmail.com");
		login.setGender(1);	
